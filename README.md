...
- [softleader/jib-memory-calculator-extension-maven](https://github.com/softleader/jib-memory-calculator-extension-maven) - Jib memory calculator extension maven (today)
